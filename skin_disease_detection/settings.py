...
# SECRET_KEY = 'y2#9%o)@p)k*q-1)%yhr25yg!3k_gp&p-x5)p#7!_7ki6e6$z1'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Only needed for collectstatic in production
